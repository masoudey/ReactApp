...
app.use(_express2.default.static('public')).use(_accounts2.default).use('/api', _api2.default).get('*', function () {
	var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(req, res) {
		var user, store, token, match, _ref3, path, component, params, context, modules, html, finalState, bundles, styles, scripts, renderFullPage;
			...
			while (1) {
				switch (_context2.prev = _context2.next) {
					...
					case 9:
						...
						_context2.next = 18;
						return store.dispatch(component.fetchData(_extends({}, params)));
